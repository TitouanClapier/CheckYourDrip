...
![results](training/runs/dress_code_detector/results.png)
...
![BoxPR_curve](training/runs/dress_code_detector/BoxPR_curve.png)
...
![BoxP_curve](training/runs/dress_code_detector/BoxP_curve.png)
...
![BoxR_curve](training/runs/dress_code_detector/BoxR_curve.png)
...
![BoxF1_curve](training/runs/dress_code_detector/BoxF1_curve.png)
...
![confusion_matrix_normalized](training/runs/dress_code_detector/confusion_matrix_normalized.png)
...
![labels](training/runs/dress_code_detector/labels.jpg)
...
|---|---|
| ![train_batch0](training/runs/dress_code_detector/train_batch0.jpg) | ![train_batch_end](training/runs/dress_code_detector/train_batch21660.jpg) |
...
|---|---|
| ![val_labels0](training/runs/dress_code_detector/val_batch0_labels.jpg) | ![val_pred0](training/runs/dress_code_detector/val_batch0_pred.jpg) |
| ![val_labels1](training/runs/dress_code_detector/val_batch1_labels.jpg) | ![val_pred1](training/runs/dress_code_detector/val_batch1_pred.jpg) |
| ![val_labels2](training/runs/dress_code_detector/val_batch2_labels.jpg) | ![val_pred2](training/runs/dress_code_detector/val_batch2_pred.jpg) |
